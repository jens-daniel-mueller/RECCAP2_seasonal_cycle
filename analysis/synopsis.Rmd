...
amplitudes %>%
  ...
  map(
    ~ ggplot(
      ...
      geom_ribbon(aes(fill = class), alpha = 0.5) +
      labs(y = .x$parameter) +
      scale_color_manual(values = c("#228833", "#4477AA"), name = "product") +
      scale_fill_manual(values = c("#228833", "#4477AA"), name = "product") +
...
pdf("output/min_max_ensemble.pdf",
    width = 8,
    height = 6)
